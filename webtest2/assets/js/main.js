...
// Thêm đoạn mã JavaScript để cập nhật giá trị khi di chuyển thanh khoảng giá
// Lấy phần tử thanh trượt từ DOM bằng ID
var slider = document.getElementById("slider");

// Lấy phần tử hiển thị từ DOM bằng ID
var display = document.getElementById("display");

// Thiết lập sự kiện cho thanh trượt khi giá trị thay đổi
slider.oninput = function() {
  // Gán giá trị hiện tại của thanh trượt cho giá trị của ô hiển thị
